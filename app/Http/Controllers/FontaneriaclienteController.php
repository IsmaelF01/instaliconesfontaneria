...
class FontaneriaclienteController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $fontaneria = Fontaneria::where('nombre', 'LIKE', '%'.$query.'%')->orderBy('id', 'asc')->paginate(8);
        return view("tienda.fontaneria", ["fontaneria" => $fontaneria, "user" => $user]);
    }

    public function indexCateg($categoria)
    {
        $user = User::find(Auth::id());
        $fontaneria = Fontaneria::where('categoria', '=', $categoria)->paginate(8);
        return view("tienda.fontaneria", ["fontaneria" => $fontaneria, "user" => $user]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->action([FontaneriaclienteController::class, 'index']);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->action(
            [FontaneriaclienteController::class, 'index']
        );
    }
}
