<x-tienda-layout>
    <h3 class="mb-4 text-lg font-semibold text-gray-900" style="margin-left: 5%; float: left;">Averias</h3>
        <div class="m-3">
            <button style="position: absolute; top: 80px; right: 70px" onclick="document.getElementById('myModal').showModal()"
                ...
                <span class="mr-2">New Averia</span>
        ...
        <dialog id="myModal" class="h-auto w-11/12 md:w-1/2 p-5 rounded-md ">
            ...
            <div class="flex flex-col w-full h-auto ">
                ...
                <div class=" flex items-center justify-center">
                    ...
                    <form action="/tienda/averias/store" method="POST" id="form"
                        ...
                        <div class="bg-white grid rounded-lg w-11/12 md:w-9/12 lg:w-1/2">
                            <div class="flex justify-center">
                                <div class="flex">
                                    <h1 class="text-gray-600 font-bold md:text-2xl text-xl">Informe Averias</h1>
                                </div>
                            </div>

                            <div class="grid grid-cols-1 mt-5 mx-7">
                                <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Descripcion</label>
                                <textarea required class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" name="descripcion" id="descripcion" cols="10" rows="10" placeholder="Descripcion ..."></textarea>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                                <div class="grid grid-cols-1">
                                    ...
                                    <input
                                        ...
                                        type="text" id="direccion" name="direccion" placeholder="Ciudad ..." required/>
                                </div>
                                <div class="grid grid-cols-1">
