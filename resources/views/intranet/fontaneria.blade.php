                        ...
                        @foreach ($fontaneria as $fonta)
                            <tr class="border-b hover:bg-orange-100 bg-gray-100">
                                ...
                                <td class="p-3 px-5 flex justify-end">
                                    ...
                                    <button onclick="document.getElementById({{$fonta->id}}).showModal()" style="margin-right: 10px;" type="button" class="focus:outline-none text-white text-sm py-1 px-2 rounded-md bg-yellow-500 hover:bg-yellow-600 hover:shadow-lg">
                                        Update
                                ...
                                <dialog id="{{$fonta->id}}"="h-auto w-11/12 md:w-1/2 p-5  bg-white rounded-md ">
                                    <div class="flex flex-col w-full h-auto ">
                                        <!-- Header -->
                                        <div class="flex w-full h-auto justify-center items-center">
                                            <div
                                            ...
                                            <div onclick="document.getElementById({{$fonta->id}}).close();"
                                                class="flex w-1/12 h-auto justify-center cursor-pointer">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <!-- Modal Content-->
                                        <div
                                            class="py-2 px-40 justify-center items-center bg-gray-200 rounded text-center text-gray-500">
                                            <div class="px-40 flex items-center justify-center" style="height: 300px">
                                                <form action="/intranet/trabajador/fontaneria/{{ $fonta->id }}/update" method="POST" id="form"
                                                    enctype="multipart/form-data">
                                                    <h1 class="block text-gray-700 font-bold mb-2 text-xl text-center" style="position: absolute; left: 20%; top:30%;">
                                                        Modificando {{$fonta->nombre}}</h1>
                                                    @csrf
                                                    <br>

                                                    <div class="mb-4">
                                                        <label class="block text-gray-700 text-sm font-bold mb-2"
                                                            for="name" style="position: absolute; left: 20%; top:40%;">
                                                            Descripcion
                                                        </label>
                                                        ...
                                                        name="descripcion" id="descripcion" type="text"
                                                        placeholder="Cambia la descripcion" required style="position: absolute; left: 15%; top:45%; width: 70%; height: 100px;"></textarea>
                                                    </div>

                                                    <div class="mb-4">
                                                        <label class="block text-gray-700 text-sm font-bold mb-2"
                                                            for="name" style="position: absolute; left: 20%; top:70%;">
                                                            Precio
                                                        </label>
                                                        <input
                                                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                            name="precio" id="precio" type="text"
                                                            placeholder="Cambia el precio" required  style="position: absolute; left: 15%; top:75%; width: 70%;">
                                                    </div>

                                                    <div class="flex items-right justify-between">
                                                        <button id="submit"
                                                            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                                                            type="submit" style="position: absolute; bottom: 5%; right: 10%;">
                                                            Create <img src="/img/mas.svg" alt=""
                                                                style="float: right; margin-left: 5px">
                                                        </button>
                                                    </div>
